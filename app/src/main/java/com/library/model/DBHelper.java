...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String createCommunityTable=
            "CREATE TABLE community (com_id INTEGER PRIMARY KEY, com_name TEXT, com_icon TEXT, com_date INTEGER, com_level TEXT, com_preid INTEGER, com_viceid INTEGER, com_secid INTEGER, isUp INTEGER)";
    private static final String createCustomerTable=
            "CREATE TABLE customer (cus_id INTEGER PRIMARY KEY, cus_account TEXT, cus_pwd TEXT, cus_sid TEXT, cus_name TEXT, cus_facebook TEXT, cus_tel TEXT, cus_gender INTEGER, cus_email TEXT, cus_address TEXT, cus_date INTEGER, cus_photo TEXT, cus_birth DATE, cus_level TEXT, cus_exp TEXT, cus_logtime INTEGER, cus_lat TEXT, cus_lng TEXT, cus_public INTEGER, isUp INTEGER)";
    private static final String createFavoritesRouteTable=
            "CREATE TABLE favorites_route (fav_no INTEGER PRIMARY KEY, cus_id INTEGER, route_id INTEGER, isUp INTEGER)";
    private static final String createMemberTable=
            "CREATE TABLE member (member_no INTEGER PRIMARY KEY, com_id INTEGER, cus_id INTEGER, pal_check INTEGER, isUp INTEGER)";
    private static final String createPalTable=
            "CREATE TABLE pal (pal_no INTEGER PRIMARY KEY, cus_id INTEGER, pal_id INTEGER, pal_check INTEGER, isUp INTEGER)";
    private static final String createPhotoRecordlTable=
            "CREATE TABLE photo_record (photo_no INTEGER PRIMARY KEY, cus_id INTEGER, task_id INTEGER, route_id INTEGER, photo_date DATE, photo_time TEXT, photo_lat TEXT, photo_lng TEXT, photo_path TEXT, isUp INTEGER)";
    private static final String createRouteTable=
            "CREATE TABLE route (route_no INTEGER , route_id INTEGER, route_name TEXT, route_seq INTEGER, route_lat TEXT, route_lng TEXT, route_alt TEXT, route_scenery TEXT, cus_id INTEGER, route_share INTEGER, route_public INTEGER, route_demo TEXT, isUp INTEGER)";
    private static final String createSportRecordTable=
            "CREATE TABLE sport_record (sportrec_no INTEGER PRIMARY KEY, cus_id INTEGER, task_id INTEGER, route_id INTEGER, sport_date INTEGER, sport_time INTEGER, sprot_lat TEXT, sport_lng TEXT, sport_acc TEXT, sport_alt TEXT, sport_gpssp TEXT, sport_speed TEXT, sport_heart TEXT, sport_cad TEXT, isUp INTEGER)";
    private static final String createTaskTable=
            "CREATE TABLE task (task_id INTEGER PRIMARY KEY, task_name TEXT, cus_id INTEGER, task_date INTEGER, route_id INTEGER, task_dis INTEGER, task_time INTEGER, task_heart INTEGER, task_cad INTEGER, task_sp INTEGER, task_exp TEXT, isUp INTEGER)";
